...
function Dishes() {
    ...
    return (
        <div>
            <Banner title={`${foodCategory}`} image="https://i.ibb.co/ygJzNNP/background5.jpg"/>
            ...
            {meals.map(meal=> <FoodItemCard key={meal.idMeal} title={meal.strMeal} image={meal.strMealThumb}/>)}
